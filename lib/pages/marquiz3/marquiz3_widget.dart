...
import 'marquiz3_model.dart';
export 'marquiz3_model.dart';

class Marquiz3Widget extends StatefulWidget {
  const Marquiz3Widget({super.key});

  @override
  State<Marquiz3Widget> createState() => _Marquiz3WidgetState();
}

class _Marquiz3WidgetState extends State<Marquiz3Widget>
    with TickerProviderStateMixin {
  late Marquiz3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Marquiz3Model());
