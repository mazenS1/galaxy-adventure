...
import 'marsquiz1_model.dart';
export 'marsquiz1_model.dart';

class Marsquiz1Widget extends StatefulWidget {
  const Marsquiz1Widget({super.key});

  @override
  State<Marsquiz1Widget> createState() => _Marsquiz1WidgetState();
}

class _Marsquiz1WidgetState extends State<Marsquiz1Widget>
    with TickerProviderStateMixin {
  late Marsquiz1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Marsquiz1Model());
