...
import 'jupiterquiz2_model.dart';
export 'jupiterquiz2_model.dart';

class Jupiterquiz2Widget extends StatefulWidget {
  const Jupiterquiz2Widget({super.key});

  @override
  State<Jupiterquiz2Widget> createState() => _Jupiterquiz2WidgetState();
}

class _Jupiterquiz2WidgetState extends State<Jupiterquiz2Widget>
    with TickerProviderStateMixin {
  late Jupiterquiz2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Jupiterquiz2Model());
