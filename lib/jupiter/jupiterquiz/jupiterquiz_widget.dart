...
import 'jupiterquiz_model.dart';
export 'jupiterquiz_model.dart';

class JupiterquizWidget extends StatefulWidget {
  const JupiterquizWidget({super.key});

  @override
  State<JupiterquizWidget> createState() => _JupiterquizWidgetState();
}

class _JupiterquizWidgetState extends State<JupiterquizWidget>
    with TickerProviderStateMixin {
  late JupiterquizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JupiterquizModel());
