...
import 'jupiterquiz1_model.dart';
export 'jupiterquiz1_model.dart';

class Jupiterquiz1Widget extends StatefulWidget {
  const Jupiterquiz1Widget({super.key});

  @override
  State<Jupiterquiz1Widget> createState() => _Jupiterquiz1WidgetState();
}

class _Jupiterquiz1WidgetState extends State<Jupiterquiz1Widget>
    with TickerProviderStateMixin {
  late Jupiterquiz1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Jupiterquiz1Model());
                                                ...
                                                Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          0.0, -1.0),
                                                  child: Text(
                                                    'what is it mainly composed from?',
